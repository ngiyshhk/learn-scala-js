...
/** @constructor */
function $c_Llearnjs_TutorialApp$() {
  $c_O.call(this)
}
$c_Llearnjs_TutorialApp$.prototype = new $h_O();
$c_Llearnjs_TutorialApp$.prototype.constructor = $c_Llearnjs_TutorialApp$;
/** @constructor */
function $h_Llearnjs_TutorialApp$() {
  /*<skip>*/
}
$h_Llearnjs_TutorialApp$.prototype = $c_Llearnjs_TutorialApp$.prototype;
$c_Llearnjs_TutorialApp$.prototype.init___ = (function() {
  return this
});
$c_Llearnjs_TutorialApp$.prototype.setupUI__V = (function() {
  (0, $m_Lorg_scalajs_jquery_package$().jQuery$1)("<button type=\"button\">Click me!</button>").click((function($this) {
    return (function() {
      $m_Llearnjs_TutorialApp$().addClickedMessage__V()
    })
  })(this)).appendTo((0, $m_Lorg_scalajs_jquery_package$().jQuery$1)("body"));
  (0, $m_Lorg_scalajs_jquery_package$().jQuery$1)("body").append("<p>Hello World</p>")
});
$c_Llearnjs_TutorialApp$.prototype.addClickedMessage__V = (function() {
  (0, $m_Lorg_scalajs_jquery_package$().jQuery$1)("body").append("<p>You clicked the button!</p>")
});
$c_Llearnjs_TutorialApp$.prototype.main__AT__V = (function(args) {
  (0, $m_Lorg_scalajs_jquery_package$().jQuery$1)((function($this) {
    return (function() {
      $m_Llearnjs_TutorialApp$().setupUI__V()
    })
  })(this))
});
var $d_Llearnjs_TutorialApp$ = new $TypeData().initClass({
  Llearnjs_TutorialApp$: 0
}, false, "learnjs.TutorialApp$", {
  Llearnjs_TutorialApp$: 1,
  O: 1
});
$c_Llearnjs_TutorialApp$.prototype.$classData = $d_Llearnjs_TutorialApp$;
var $n_Llearnjs_TutorialApp$ = (void 0);
function $m_Llearnjs_TutorialApp$() {
  if ((!$n_Llearnjs_TutorialApp$)) {
    $n_Llearnjs_TutorialApp$ = new $c_Llearnjs_TutorialApp$().init___()
  };
  return $n_Llearnjs_TutorialApp$
}
/** @constructor */
...
$m_Llearnjs_TutorialApp$().main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
}).call(this);
//# sourceMappingURL=learn-scala-js-fastopt.js.map
